...
export function BrandKit() {
  ...
  return (
    <div className="story-tab-scroll bk2-root">
      <SettingsPanelHeader icon="🎨" title="Brand Kit" subtitle="Visual identity defaults for the Page Designer — fonts, colours, and shape settings." action={<ButtonView size="sm" variant="secondary" onClick={reset}>Reset to defaults</ButtonView>} />
      ...
      <div className="bk2-grid">
        ...
        <div className="bk2-card">
          <div className="bk2-card-title"><span>Aa</span> Typography</div>

          <div className="bk2-section">
            <div className="bk2-section-label">Font picker</div>
          ...
          <div className="bk2-section">
            <div className="bk2-section-label">Quick select</div>
        ...
        {/* ── Colours ── */}
        <div className="bk2-card">
          <div className="bk2-card-title"><span>🎨</span> Colours</div>

          <div className="bk2-section">
            <div className="bk2-section-label">Palette</div>
          ...
          <div className="bk2-section">
            <div className="bk2-section-label">Shape &amp; opacity</div>
          ...
          <div className="bk2-section">
            <div className="bk2-section-label">Live preview</div>
            <div
