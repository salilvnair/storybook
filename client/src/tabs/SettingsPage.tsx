...
import { StoryLibrary } from '../components/settings/StoryLibrary';
import { DevTools } from '../components/devtools/DevTools';
import { BookIcon, CpuIcon, SparkleIcon, PaletteIcon, WandIcon, DatabaseIcon, ScrollIcon } from '../icons';

type Section = 'general' | 'providers' | 'prompts' | 'theme' | 'features' | 'library' | 'devtools';
...
const NAV: { id: Section; label: string; icon: ReactNode; color: string }[] = [
  ...
  { id: 'library', label: 'Library', icon: <ScrollIcon size={15} />, color: '#60a5fa' },
